...
export function SignInThree() {
  return (
    ...
    <section>
      <div className="flex items-center justify-center px-4 -mt-14 max-sm:-mt-4 py-10 sm:px-6 sm:py-16 lg:px-8 lg:py-24">
        <div className="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md">
          <div className="mb-2 w-[20%] mx-auto flex justify-center">
           <img src={logo} alt="" />
          </div>
